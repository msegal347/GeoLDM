...
def main():
    ...
    parser.add_argument(
        ...
        type=eval,
        default=False,
        help="Perform test to evaluate negative log-likelihood for the validation and test partitions",
    )
    ...
    device = (
        torch.device("cuda:{}".format(eval_args.gpu_id))
